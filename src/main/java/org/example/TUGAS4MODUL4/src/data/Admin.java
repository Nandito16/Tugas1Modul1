...
public class Admin extends User implements iMenu{
    ...
    private boolean isAdmin(String username, String password) {
        ...
        return username.equals("Dito") && password.equals("DitoGanteng");
    }
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    System.out.println("ALHAMDULILLAH MBARI");
                    return;
                default:
                    System.out.println("RAONO PILIHANE!");
            }
        }
    }
