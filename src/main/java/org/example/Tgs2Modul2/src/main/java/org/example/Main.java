...
public class Main {
    ...
    private static ArrayList<Book> Buku = new ArrayList<>();
    private static Scanner scanner = new Scanner(System.in);
    public static void main(String[] args) {

        Buku.add(new Book("388c-e681-9152", "How2Basic", "Vsauce", "Pendidikan", 3));
        Buku.add(new Book("ed90-be30-5cdb", "Hawwy potah", "Icewallowcome", "Horror", 2));
        Buku.add(new Book("d95e-0c4a-9523", "pen beli trek", "alul", "SciFi", 3));
        ...
        while (true) {
            ...
            switch (userInput) {
                case 1:
                    ...
                    break;
                case 2:
                    student.borrowBook(Buku, scanner);
                    break;
                case 3:
