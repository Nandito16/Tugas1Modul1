...
public class Admin extends User implements iMenu{
    ...
    private boolean isAdmin(String username, String password) throws illegalAdminAccess {
        if (username.equals("Dito") &&  password.equals("Dito123")){
            return true;
        }
        else {
    ...
    private void inputBook() {
        ...
        switch (bookType) {
            case 1:
                ...
                daftarBuku.set(i++, new HistoryBook(idBuku, judul, stok, category, author));
                break;
            case 2:
                idBuku = generateId("SB");
                daftarBuku.set(i++, new StoryBook(idBuku, judul, stok, category, author));
                break;
            case 3:
                idBuku = generateId("TB");
                daftarBuku.set(i++, new TextBook(idBuku, judul, stok, category, author));
                break;
            default:
                System.out.println("Pilihan tidak valid!");
                return;
