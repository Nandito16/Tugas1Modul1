...
public class LibrarySystem {
    ...
    public static void main(String[] args) {
        daftarBuku.add(i++, new StoryBook("SB32F", "Jiraiya", 17, "Story", "Martis"));
        daftarBuku.add(i++, new HistoryBook("HB324", "Satu Hari", 2, "History", "Moskov"));
        daftarBuku.add(i++, new TextBook("TB323", "Pasutri", 4, "Text", "Eudora"));

        studentList.add(0, new Student("202310370311194", "Daito", "Teknik","Mesin"));
        studentList.add(1, new Student("202310370311195", "Opik", "Teknik","Informatika"));
        studentList.add(2, new Student("202310370311196", "Naruto", "Teknik","Elektro"));
