...
public class Main {
    ...
    public static void main(String[] args) {
        // Mengisi stok buku
        bookList.add(0, new Book("tfs2-jhk4-878d", "Pancasila", 9, "kamu"));
        bookList.add(1, new Book("876u-hhgh-6j23", "Sakit Jiwa", 30, "dia"));
        bookList.add(2, new Book("87ds-mnb6-iuk2", "Gamers", 8, "aku"));
        ...
        while (isRunning) {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    System.out.println("Thank u nah");
                    isRunning = false;
                    break;
                default:
    ...
    public static class Student extends User {
        ...
        public void displayBooks() {
            ...
            for (Book book : bookList) {
                if (book != null) {
                    System.out.println("- Id Buku: " + book.getIdBuku() + "- " + book.getJudul() + " oleh " + book.getAuthor() + " (Stok: " + book.getStok() + ")");
                }
            }
        }
